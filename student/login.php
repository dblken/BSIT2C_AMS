...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($result->num_rows == 1) {
        ...
        // Check if the password matches either directly or with password_verify
...
<html>
<head>
    <title>Student Login - BSIT 2C AMS</title>
    ...
    <script>
        ...
        forgotForm.addEventListener('submit', function(e) {
            ...
            fetch('../forgot_password.php', {
                ...
                body: 'email=' + encodeURIComponent(document.getElementById('forgotEmail').value) + '&role=student'
            })
            .then(res => {
                if (!res.ok) {
