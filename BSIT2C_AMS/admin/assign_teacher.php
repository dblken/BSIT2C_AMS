...
// Function to get current weekly classes count
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    try {
        // Check total weekly classes for this teacher
        $total_classes_sql = "SELECT SUM(weekly_classes) as total 
                            FROM timetable 
                            WHERE subject_id IN (SELECT id FROM subjects WHERE teacher_id = ?)";
        ...
        $sql = "INSERT INTO timetable (subject_id, weekly_classes, day_of_week, start_time, end_time, room) 
