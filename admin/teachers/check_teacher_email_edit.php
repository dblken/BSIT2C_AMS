...
if (isset($_POST['email']) && isset($_POST['teacher_id'])) {
    ...
    // Check if email exists in the database for any teacher other than the current one
    ...
    echo json_encode(['exists' => false, 'error' => 'Email or teacher ID not provided']);
}
